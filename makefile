...
comp: main_comp.o RandomGenerator.o StocasticProcess.o UnderlyingPath.o Option.o MonteCarloPricer.o Statistics.o 
	nvcc -gencode arch=compute_20,code=sm_20 main_comp.o RandomGenerator.o StocasticProcess.o UnderlyingPath.o Option.o MonteCarloPricer.o Statistics.o -o pricer_comp
